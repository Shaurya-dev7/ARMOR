...
const TechOrbitDisplay = memo(function TechOrbitDisplay({
  ...
  return (
    <section className='relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg'>
      <span className='pointer-events-none relative z-10 whitespace-pre-wrap bg-gradient-to-b from-black to-gray-300/80 bg-clip-text text-center text-7xl font-semibold leading-none text-transparent dark:from-white dark:to-slate-900/10'>
        {text}
      </span>
                ...
                <section className='relative'>
                  {field.type === 'select' ? (
                    <select
                      ...
                      className={cn(
                        "flex h-10 w-full rounded-md border border-input bg-gray-50 dark:bg-zinc-800 px-3 py-2 text-sm text-black dark:text-white transition duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 dark:focus-visible:ring-neutral-600",
                        "appearance-none bg-[url('data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20fill%3D%22none%22%20viewBox%3D%220%200%2024%2024%20stroke%3D%22currentColor%22%20stroke-width%3D%222%22%3E%3Cpath%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%20d%3D%22M19%209l-7%207-7-7%22%2F%3E%3C%2Fsvg%3E')] bg-[length:1.25rem_1.25rem] bg-[right_0.5rem_center] bg-no-repeat"
                      )}
                    >
...
const AuthTabs = memo(function AuthTabs({
  ...
  return (
    <div className='flex max-lg:justify-center w-full md:w-auto'>
      <div className='w-full lg:w-1/2 min-h-[100dvh] flex flex-col justify-center items-center max-lg:px-[10%] py-12'>
        <AnimatedForm
          {...formFields}
          fieldPerRow={1}
